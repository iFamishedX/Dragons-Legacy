...
| **Glow System** | Combine the egg with materials in an anvil to change its glow color |
...
| **Offline Reset** | Bearer is cleared after a configurable number of offline days |
...
| **[Ability System](Ability-System.md)** | Dragon's Hunger deep-dive: effects, attributes, scaling, elytra blocking |
| **[Passive Effects](Passive-Effects.md)** | What the bearer receives just from holding the egg |
| **[Glow System](Glow-System.md)** | Anvil crafting recipes, supported materials, and custom colors |
...
| **[Migration Guide](Migration-Guide.md)** | Upgrading from a single-file config to the multi-file layout |
